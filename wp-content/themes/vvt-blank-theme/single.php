	...
	<div id="container">
		<div id="content">
			...
			<div class="entry-utility">
				...
				<!-- Text in the blog, under comments --> 
				<?php printf( __( 'This entry was posted in %1$s%2$s.</br> Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.</br> Follow any comments here with the <a href="%5$s" title="Comments RSS to %4$s" rel="alternate" type="application/rss+xml">RSS feed for this post</a>.', 'hbd-theme' ),
